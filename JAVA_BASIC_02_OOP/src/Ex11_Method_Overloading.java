/*
OOP 객체 지향 프로그래밍 (여러개의 작은 조각(작은 설계도) 만들어서 조합(큰설계도) 하는 행위)
>> 설계도를 재사용 


1. 상속 (재사용성) 
2. 캡슐화 (은닉화) : private ... setter, getter(직접할당을 막고.. 간접할당을 통해 데이터 보호)
3. 다형성 : 하나의 타이븡로 여러개 객체의 주소를 가질 수 있는 것
...
public class Ex11_Method_Overloading {
	...
	public static void main(String[] args) {
		...
		overt.add(10,20); //parameter 정의가 일치하는 함수가 자동 호출)
		//overt.add(10.1f,10);
		overt.add("A");
