...
public class Ex05_Operation {
	...
	public static void main(String[] args) {
		...
		/*
		 Today point
		 1.정수인 연산은 [int]타입으로 변환 후 처리된다
		 ex) byte +short >> 컴파일러가 내부적으로 값들을  int  방에 넣고 cjfl >>int +int 처리
		 ex) char +char >> 컴파일러가 내부적으로  int+int처리
		...
		*/
		...
		//제어문
		int sum=0; //local variable (사용진 반드시 초기화)
		...
		System.out.println(month + " 월 은" + res + "일자 까지 입니다");      
		
		// 난수 (랜덤값, 임의의 수술값) 을 얻기를 원해요
		// 쉬운방법 : 구글 검색(친절하게)
		// 자바를 만든이는 자습서 (API 문서) 자원에 대한 설명과 사용방법(영어) 
